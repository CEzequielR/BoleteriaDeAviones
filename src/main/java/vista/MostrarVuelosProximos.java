 ...
 * @author Lenovo
 */
public class MostrarVuelosProximos extends javax.swing.JFrame {

    /**
     * Creates new form Autenticacion
     */
    public MostrarVuelosProximos() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VUELOS DENTRO DE UNA HORA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarVuelosProximos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarVuelosProximos().setVisible(true);
            }
        });
    }
